...
public class ShiroUserLoginToken extends UsernamePasswordToken {
     ...
     */
    public ShiroUserLoginToken password(@Nullable String login,
                                        @Nullable String password) throws InvalidCredentialFieldException {
     ...
     */
    public ShiroUserLoginToken phoneCaptcha(@Nullable String phone,
                                            @Nullable String captcha) throws InvalidCredentialFieldException {
