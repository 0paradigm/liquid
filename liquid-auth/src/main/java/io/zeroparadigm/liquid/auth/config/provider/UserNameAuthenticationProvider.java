package io.zeroparadigm.liquid.auth.config.provider;

import io.zeroparadigm.liquid.auth.utils.Md5Utils;
import lombok.Data;
...
/**
 * Customized username/password login verification。
 *
 * @author buzzy0423
 */
@Data
public class UserNameAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    /**
     * Rewrite authorization authentication check method to implement custom user account password authentication
     */
    @Override
