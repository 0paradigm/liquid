...
(
    ...
    `read`     bool NOT NULL DEFAULT FALSE COMMENT 'read + clone',
    `manage`   bool NOT NULL DEFAULT FALSE COMMENT 'manage issues + pulls',
    `push`     bool NOT NULL DEFAULT FALSE,
    `settings` bool NOT NULL DEFAULT FALSE COMMENT 'manage settings',
    `admin`    bool NOT NULL DEFAULT FALSE COMMENT 'add collaborators + delete',
